...
// Get the English word and assign it to the "userInput" variable
function getUserWord() {
  userWord = target.value
}
userInputBox.onkeyup = getUserWord
...
// Display the translated Pig Latin word:
translation.innerHTML = pWord


// clear the form and output when user clicks the reset button.
reset.addEventListener('click', (clear) => {
  userInput.value = '';
  translation.innerHTML = ''
})

// function to translate the English word to Pig Latin:
const pigLatin = (word) => {
